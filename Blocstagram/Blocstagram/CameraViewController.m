            ...
            if (granted) {
                ...
                if (!input) {
                    [self presentAlertWithTitle:error.localizedDescription
                                 ...
                                 dismissHandler:^(UIAlertAction *action) {
                ...
                [self presentAlertWithTitle:NSLocalizedString(@"Camera Permission Denied", @"camera permission denied title")
...
- (void)cameraButtonPressedOnToolbar:(CameraToolbar *)toolbar {
    ...
    [self.stillImageOutput captureStillImageAsynchronouslyFromConnection:videoConnection completionHandler:^(CMSampleBufferRef imageDataSampleBuffer, NSError *error) {
        ...
        if (imageDataSampleBuffer) {
            ...
            CGSize aspectRatioExample = self.captureVideoPreviewLayer.bounds.size;
            ...
            image = [image imageByScalingToSize:aspectRatioExample andCroppingWithRect:cropRect];
            ...
            dispatch_async(dispatch_get_main_queue(), ^{
                [self presentAlertWithTitle:error.localizedDescription message:error.localizedRecoverySuggestion dismissHandler:^(UIAlertAction *action) {
                    [self.delegate cameraViewController:self didCompleteWithImage:nil];
                }];
            });
        }
...
- (void) presentAlertWithTitle:(NSString *)title message:(NSString *)message dismissHandler:(void (^)(UIAlertAction *action))handler {
