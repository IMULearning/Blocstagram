...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    return [MediaTableViewCell heightForMediaItem:media width:CGRectGetWidth(self.view.frame) traitCollection:self.view.traitCollection];
}
...
- (void) cameraPressed:(UIBarButtonItem *) sender {
    ...
    if ([UIImagePickerController isSourceTypeAvailable:UIImagePickerControllerSourceTypeCamera]) {
        ...
        ImageLibraryViewController *libVC = [[ImageLibraryViewController alloc] init];
        libVC.delegate = self;
        imageVC = libVC;
    }
...
- (void) handleImage:(UIImage *)image withNavigationController:(UINavigationController *)navVC {
    if (image) {
        PostToInstagramViewController *postVC = [[PostToInstagramViewController alloc] initWithImage:image];
        [navVC pushViewController:postVC animated:YES];
    } else {
